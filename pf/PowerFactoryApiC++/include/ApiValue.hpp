...
namespace api {
  ...
  public:
    ...
    Value(DataObjectPtr val);
    Value(const unsigned int countRows, const unsigned int countCols); //constructor for type matrix
    ...
    DataObjectPtr GetDataObject(int* error=0) const;
    ...
    void VecInsertDataObject(DataObjectPtr val, int* error=0);
    ...
    DataObjectPtr VecGetDataObject(const unsigned int idx, int* error=0) const;
