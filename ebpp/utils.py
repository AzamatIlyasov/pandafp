...
required_props = {
    ...
    "lineParam": ["from_bus", "to_bus", "length_km", "r_ohm_per_km", "x_ohm_per_km", "c_nf_per_km", "max_i_ka"],
    "switch": ["bus", "element", "et"],
    "trafo": ["hv_bus", "lv_bus", "std_type"],
    "trafoStd": ["hv_bus", "lv_bus", "std_type"],
    "trafoParam": ["hv_bus", "lv_bus", "sn_mva", "vn_hv_kv", "vn_lv_kv", "vk_percent", "vkr_percent", "pfe_kw", "i0_percent"],
